...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/56993761200) */
    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/Elmo/ElmooBot/master/src/avatar_contact.png';
          try {
